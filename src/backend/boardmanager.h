...
signals:
    ...
    void startGameResponded(bool success, QString error, bool waiting, uint lobbyKey, QString nextState, uint8_t nextPlayer, QHash<QPoint, QList<QPoint>> adjacentPieces);
